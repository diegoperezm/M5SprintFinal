...
<%@ page import="model.Capacitaciones"%>
<%
	...
	<div class="container mt-5 w-75 justify-content-center">
		<div class="est">
			...
			<table id="dataTable" class="table display responsive nowrap"
				...
				<tbody>
					<%
					List<Capacitaciones> lista = (ArrayList<Capacitaciones>) request.getAttribute("listaCapacitaciones");
					for (Capacitaciones cap:  lista) {
					%>
					<tr>
						<td><%=cap.getId()%></td>
						<td><%=cap.getNombre()%></td>
